              ...
              <form action="" name="verify_purchase" method="post" class="form form-horizontal" enctype="multipart/form-data" id="api_form">
                ...
                <div class="section-body">
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input type="text" name="envato_buyer_name" id="envato_buyer_name" value="Nulled" class="form-control" placeholder="Nulled">
                    </div>
                  </div>
                  <div class="form-group">
              ...
              <div class="section">
                <div class="section-body">
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input type="text" name="app_from_email" id="app_from_email" value="<?php echo $settings_row['app_from_email'];?>" class="form-control">
                    </div>
                  </div>
                  <div class="form-group">
